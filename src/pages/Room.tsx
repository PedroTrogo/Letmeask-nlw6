...
export function Room() {
	...
	async function handleSendQuestion(event: FormEvent) {
		...
		if(!roomRef.exists()){
			alert("Essa sala não existe mais");
		...
		await roomRef.ref.child('/questions').push(questionData);
			...
			<main>
				...
				<form onSubmit={handleSendQuestion}>
					...
					<div className='form-footer'>
						...
						<Button disabled={(newQuestion.trim() === '' || !user)}>
							Enviar pergunta
						</Button>
					</div>
				</form>
						...
						questions.map(question => (
							...
							>
								...
								<ActionIcon 
									...
									className={question.likeId ? 'activated' : ''}
